...
export const CSA_EVENT = {
  ...
  CRA_REJECTED: 'CRA_REJECTED',
  CRA_RECYCLED: 'CRA_RECYCLED',
  CRA_PROBLEM_DEDUCTED: 'CRA_PROBLEM_DEDUCTED',
  FAILURE_IN_BATCH_TBD: 'FAILURE_IN_BATCH_TBD',
...
export const SYSTEM_CSA_EVENTS = new Set<string>([
  ...
  CSA_EVENT.CRA_PROBLEM_DEDUCTED,
  CSA_EVENT.FAILURE_IN_BATCH_TBD,
