export const CSA_STATUS = {
  ...
  CRA_ERROR_APPLICATION: 'cra_error_application',
  CRA_ERROR_CANCELLATION: 'cra_error_cancellation',
  OVER_18: 'over_18',
} as const
...
export const CSA_STATUS_LABELS: Record<string, string> = {
  ...
  [CSA_STATUS.CRA_ERROR_APPLICATION]: 'CRA Error - Application',
  [CSA_STATUS.CRA_ERROR_CANCELLATION]: 'CRA Error - Cancellation',
...
export const REMOVE_FROM_BATCH_TARGET: Record<string, string> = {
  ...
  [CSA_STATUS.CRA_ERROR_APPLICATION]: CSA_STATUS.CRA_ERROR_APPLICATION,
  [CSA_STATUS.CRA_ERROR_CANCELLATION]: CSA_STATUS.CRA_ERROR_CANCELLATION,
}
...
export const CRA_FILE_REJECTED_TARGET: Record<string, string> = {
  ...
  [CSA_STATUS.CRA_ERROR_APPLICATION]: CSA_STATUS.ELIGIBLE_TBD,
  [CSA_STATUS.CRA_ERROR_CANCELLATION]: CSA_STATUS.NOT_ELIGIBLE_IP_TBD,
}
