...
const { FILE_CREATED_PATH, FILE_CREATION_ENVIROMENT, FILE_NAME_PREFIX, FILE_TYPE_APPLICATION, FILE_TRANSACTION_CODE } = COMMON_CONSTANT;
...
export class FileCreationService {
    ...
    async createFile(
        ...
        let fileTransferResponse = await this.fileTransferClientService.sendFileToTransferService(outputPath, fileName, craUserId);
