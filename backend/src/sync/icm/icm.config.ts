...
export const ICM_INGESTION_CONFIGS: IcmApiConfig[] = [
  ...
  },
  {
    ...
    cursorLabel: 'Updated',
    searchSpec: () =>
      `([Legal Authority Code] = 'OPC-Perm Cust Trans-Cons-54.01' OR [Legal Authority Code] = 'OPO-Perm Custody Trans-54.01' OR [Legal Authority Code] = 'OPT-Perm Custody Trans-54.1') OR ([Expiry Date] IS NULL OR [Expiry Date] >= "${formatDatePacific(new Date())}")`,
