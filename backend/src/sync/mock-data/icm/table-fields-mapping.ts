...
export const STG_ICM_CASES_MAP: FieldMapEntry[] = [
  { sourceField: 'Id', sourceLabel: 'Id', masterField: 'case_row_id_icm' },
  ...
  { sourceField: 'CONTACT_ID', sourceLabel: 'Key Player Id', masterField: 'contact_row_id_icm' },
  ...
  { sourceField: 'LAST_NAME', sourceLabel: 'Subject Contact Last Name', masterField: 'last_name' },
  { sourceField: 'MID_NAME', sourceLabel: 'Middle Name', masterField: 'middle_name' },
  { sourceField: 'FST_NAME', sourceLabel: 'Subject Contact First Name', masterField: 'first_name' },
...
export const STG_ICM_PLACEMENTS_MAP: FieldMapEntry[] = [
  { sourceField: 'Id', sourceLabel: 'Id', masterField: 'placement_id_icm' },
  ...
  { sourceField: 'TYPE', sourceLabel: 'Type', masterField: 'location_type' },
  ...
  { sourceField: 'NAME', sourceLabel: 'Place of Service', masterField: 'place_of_service_name' },
  {
  ...
  { sourceField: 'Case_Id', sourceLabel: 'Case Id', masterField: 'case_rowid_icm' },
  { sourceField: 'Agreement_Id', sourceLabel: 'Agreement Id', masterField: 'agreement_id' },
]
...
export const STG_LEGAL_ADMIN_MAP: FieldMapEntry[] = [
  ...
  { sourceField: 'Id', sourceLabel: 'Id', masterField: 'legal_admin_id' },
...
export const STG_LEGAL_AUTHORITY_MAP: FieldMapEntry[] = [
  { sourceField: 'Id', sourceLabel: 'Id', masterField: 'legal_authority_code' },
  ...
  { sourceField: 'START_DT', sourceLabel: 'Effective Legal Status', masterField: 'effective_date' },
  { sourceField: 'EXPIRY_DT', sourceLabel: 'Effective Legal Status', masterField: 'expiry_date' },
...
export const STG_AGREEMENT_MAP: FieldMapEntry[] = [
  ...
  { sourceField: 'ID', sourceLabel: 'Id', masterField: 'agreement_id_icm' },
  {
...
export const STG_ORDER_MAP: FieldMapEntry[] = [
  ...
  { sourceField: 'NAME', sourceLabel: 'Product', masterField: 'product' },
  {
    sourceField: 'X_PCMS_CONTRACT_NUM',
  ...
  { sourceField: 'Id', sourceLabel: 'Id', masterField: 'order_id_icm' },
]
